	 ...
	 <div class="container">
		 ...
		 <div class="col-md-6 log">		 
				 ...
				 <form action="/myproject/ziji/index.php/User/check" method="post">
					 ...
					 <h5>验证码 :</h5>			 
 					 <input type="text" name="checkCode" required="required"><img id="myImg" onclick="javascript:this.src='/myproject/ziji/index.php/User/code/ran/'+Math.random();"  src="/myproject/ziji/index.php/User/code" align="absmiddle">					
...
<!-- 忘记密码功能 					  <a href="#">Forgot Password ?</a> -->
		  ...
		  <div class="col-md-6 login-right">
				...
				<a class="acount-btn" href="/myproject/ziji/index.php/User/reg">注册</a>
		 </div>
		 <div class="clearfix"></div>		 
